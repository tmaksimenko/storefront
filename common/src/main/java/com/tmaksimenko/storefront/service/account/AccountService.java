...
public interface AccountService {
    ...
    ResponseEntity<String> createAccount(AccountCreateDto accountCreateDto);

    ResponseEntity<String> updateAccount(Account oldAccount, AccountCreateDto accountCreateDto);
